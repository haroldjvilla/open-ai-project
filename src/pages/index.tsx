        ...
        <div className="flex flex-col gap-4 justify-center lg:w-1/3 mx-auto ">
          <div className="relative w-full">
            ...
            <textarea
              ...
              placeholder="Ejemplo: 'Joyeria Montblanc'"
            />
            {/* Character limit in bottom right of textarea  */}
            <div
              className={`absolute ${
                input.length > 30 ? "text-red-500" : ""
              } bottom-2 right-2 text-gray-400 text-xs`}
            >
          ...
          <button
            type="button"
            onClick={submit}
            className="bg-blue-500 h-12 w-full hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
          >
            {loading ? (
          ...
          {suggestion && (
            <div className="mt-8">
              <h4 className="text-lg font-semibold pb-2">Tu resultado:</h4>
